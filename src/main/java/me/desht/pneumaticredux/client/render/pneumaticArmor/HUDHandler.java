...
import me.desht.pneumaticredux.client.IKeyListener;
...
public class HUDHandler implements IKeyListener {
    ...
    public void onKeyPress(KeyBinding key) {
        ...
        if (mc.inGameHasFocus) {
            ...
            } else if (key == KeyHandler.getInstance().keybindDebuggingDrone && DroneDebugUpgradeHandler.enabledForPlayer(PneumaticRedux.proxy.getPlayer())) {
