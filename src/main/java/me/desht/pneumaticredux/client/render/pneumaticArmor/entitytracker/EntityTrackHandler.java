package me.desht.pneumaticredux.client.render.pneumaticArmor.entitytracker;

import me.desht.pneumaticredux.PneumaticRedux;
import me.desht.pneumaticredux.api.PneumaticRegistry;
import me.desht.pneumaticredux.api.client.pneumaticHelmet.IEntityTrackEntry;
import me.desht.pneumaticredux.api.client.pneumaticHelmet.IEntityTrackEntry.EntityTrackEntry;
...
import me.desht.pneumaticredux.client.render.pneumaticArmor.*;
...
import me.desht.pneumaticredux.lib.NBTKeys;
...
public class EntityTrackHandler {
    ...
    public static class EntityTrackEntryDrone extends EntityTrackEntry {
        ...
        public void addInfo(Entity entity, List<String> curInfo) {
            ...
            if (DroneDebugUpgradeHandler.enabledForPlayer(PneumaticRedux.proxy.getPlayer()) && NBTUtil.getInteger(PneumaticRedux.proxy.getPlayer().getItemStackFromSlot(EntityEquipmentSlot.HEAD), NBTKeys.PNEUMATIC_HELMET_DEBUGGING_DRONE) != entity.getEntityId()) {
    ...
    public static class EntityTrackEntryHackable extends EntityTrackEntry {
        ...
        @Override
        public boolean isApplicable(Entity entity) {
            return HackUpgradeRenderHandler.enabledForPlayer(PneumaticRedux.proxy.getPlayer());
        }

        @Override
        public void addInfo(Entity entity, List<String> curInfo) {
            IHackableEntity hackable = HackableHandler.getHackableForEntity(entity, PneumaticRedux.proxy.getPlayer());
            if (hackable != null) {
                ...
                if (hackTime == 0) {
                    hackable.addInfo(entity, curInfo, PneumaticRedux.proxy.getPlayer());
                } else {
                    int requiredHackTime = hackable.getHackTime(entity, PneumaticRedux.proxy.getPlayer());
                    ...
                    if (percentageComplete < 100) {
                        ...
                        hackable.addPostHackInfo(entity, curInfo, PneumaticRedux.proxy.getPlayer());
                    } else {
                        hackable.addInfo(entity, curInfo, PneumaticRedux.proxy.getPlayer());
                    }
                }
