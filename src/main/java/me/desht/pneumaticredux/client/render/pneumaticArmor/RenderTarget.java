...
import me.desht.pneumaticredux.client.render.RenderProgressBar;
...
import me.desht.pneumaticredux.common.network.PacketHackingEntityStart;
import me.desht.pneumaticredux.common.network.PacketUpdateDebuggingDrone;
...
public class RenderTarget {
    ...
    public void update() {
        ...
        if (hackTime > 0) {
            IHackableEntity hackableEntity = HackableHandler.getHackableForEntity(entity, PneumaticRedux.proxy.getPlayer());
    ...
    public void hack() {
        if (isInitialized() && isPlayerLookingAtTarget()) {
            ...
            if (hackable != null && (hackTime == 0 || hackTime > hackable.getHackTime(entity, PneumaticRedux.proxy.getPlayer())))
