...
import me.desht.pneumaticredux.client.gui.widget.WidgetVerticalScrollbar;
import me.desht.pneumaticredux.common.inventory.ContainerAmadron;
import me.desht.pneumaticredux.common.inventory.ContainerAmadron.EnumProblemState;
import me.desht.pneumaticredux.common.network.NetworkHandler;
import me.desht.pneumaticredux.common.network.PacketAmadronOrderUpdate;
        ...
        for (int i = 0; i < visibleOffers.size(); i++) {
            ...
            WidgetAmadronOffer widget = new WidgetAmadronOffer(i, guiLeft + 6 + 73 * (i % 2), guiTop + 55 + 35 * (i / 2), offer) {
                ...
                public void onMouseClicked(int mouseX, int mouseY, int button) {
                    NetworkHandler.sendToServer(new PacketAmadronOrderUpdate(container.offers.indexOf(getOffer()), button, PneumaticRedux.proxy.isSneakingInGui()));
                }
            };
            addWidget(widget);
