package me.desht.pneumaticredux.client.gui.widget;
...
import me.desht.pneumaticredux.common.config.HelmetWidgetDefaults;
import me.desht.pneumaticredux.common.network.NetworkHandler;
import me.desht.pneumaticredux.common.network.PacketToggleHelmetFeature;
import me.desht.pneumaticredux.lib.Names;
import me.desht.pneumaticredux.proxy.ClientProxy;
...
//                ConfigHandler.config.save();
    ...
    public static KeyBinding setOrAddKeybind(String keybindName, int keyCode) {
        ...
        if (keyCode < 0) {
            if (((ClientProxy) PneumaticRedux.proxy).keybindToKeyCodes.containsKey(keybindName)) {//If the keybind can be found in the options file
                keyCode = ((ClientProxy) PneumaticRedux.proxy).keybindToKeyCodes.get(keybindName);
            } else {
                return null;
            }
        }
