...
import me.desht.pneumaticredux.common.network.PacketUpdateEntityFilter;
...
public class GuiEntityTrackOptions implements IOptionPage {
    ...
    public void initGui(IGuiScreen gui) {
        ...
        if (PneumaticRedux.proxy.getPlayer() != null)
            textField.setText(ItemPneumaticArmor.getEntityFilter(PneumaticRedux.proxy.getPlayer().getItemStackFromSlot(EntityEquipmentSlot.HEAD)));
    }
