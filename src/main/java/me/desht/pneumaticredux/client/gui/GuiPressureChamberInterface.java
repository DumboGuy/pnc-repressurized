...
import me.desht.pneumaticredux.common.inventory.ContainerPressureChamberInterface;
...
import me.desht.pneumaticredux.common.tileentity.TileEntityPressureChamberInterface;
...
public class GuiPressureChamberInterface extends GuiPneumaticContainerBase<TileEntityPressureChamberInterface> {
    ...
    public void initGui() {
        ...
        nameFilterField = new GuiTextField(-1, fontRenderer, xStart + 91, yStart + 58, 78, 10);
        ...
        if (te.filterMode != TileEntityPressureChamberInterface.EnumFilterMode.ITEM) {
            if (inventorySlots.inventorySlots.get(5).xPos < 1000) {
                for (int i = 5; i < 14; i++) {
                    inventorySlots.inventorySlots.get(i).xPos += 1000;
                }
            }
        } else {
            if (inventorySlots.inventorySlots.get(5).xPos > 1000) {
