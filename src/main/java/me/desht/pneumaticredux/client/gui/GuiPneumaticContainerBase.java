...
import me.desht.pneumaticredux.client.gui.widget.*;
...
import me.desht.pneumaticredux.common.tileentity.*;
...
public class GuiPneumaticContainerBase<Tile extends TileEntityBase> extends GuiContainer implements /*INEIGuiHandler,*/
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        if (getInvTextOffset() != null)
            fontRenderer.drawString(I18n.format("container.inventory"), 8 + getInvTextOffset().x, ySize - 94 + getInvTextOffset().y, 4210752);
    }
    ...
    public void drawScreen(int x, int y, float partialTick) {
        ...
        for (IGuiWidget widget : widgets) {
            if (widget.getBounds().contains(x, y))
                widget.addTooltip(x, y, tooltip, PneumaticRedux.proxy.isSneakingInGui());
        }
