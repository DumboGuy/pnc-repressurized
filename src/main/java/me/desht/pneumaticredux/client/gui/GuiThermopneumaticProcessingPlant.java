...
import me.desht.pneumaticredux.client.gui.widget.WidgetTank;
import me.desht.pneumaticredux.client.gui.widget.WidgetTemperature;
import me.desht.pneumaticredux.common.inventory.ContainerThermopneumaticProcessingPlant;
import me.desht.pneumaticredux.common.tileentity.TileEntityThermopneumaticProcessingPlant;
...
public class GuiThermopneumaticProcessingPlant extends
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        String containerName = te.getDisplayName().getUnformattedText(); // I18n.format(te.getName() + ".name");
        GL11.glPushMatrix();
