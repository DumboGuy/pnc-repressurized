...
import me.desht.pneumaticredux.common.network.PacketAmadronTradeRemoved;
...
//    private final InventoryBasic inv = new InventoryBasic("amadron", true, ROWS * 4);
    ...
    public void handleGUIButtonPress(int guiID, EntityPlayer player) {
        ...
        if (guiID == 1) {
            ...
            player.openGui(PneumaticRedux.instance, CommonProxy.EnumGuiId.AMADRON_ADD_TRADE.ordinal(), player.world, 0, 0, 0);
        }
    }
