...
import me.desht.pneumaticredux.client.render.pneumaticArmor.RenderCoordWireframe;
...
IRepairable, IRevealer, IGoggles, IVisDiscountGear*/ {
    ...
    public static ItemStack getSearchedStack() {
        return getSearchedStack(PneumaticRedux.proxy.getPlayer().getItemStackFromSlot(EntityEquipmentSlot.HEAD));
    }
