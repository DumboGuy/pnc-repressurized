...
import me.desht.pneumaticredux.common.network.PacketNotifyVariablesRemote;
    ...
    private void openGui(EntityPlayer player, ItemStack remote) {
        if (player.isSneaking()) {
            if (isAllowedToEdit(player, remote)) {
                player.openGui(PneumaticRedux.instance, EnumGuiId.REMOTE_EDITOR.ordinal(), player.world, (int) player.posX, (int) player.posY, (int) player.posZ);
            ...
            player.openGui(PneumaticRedux.instance, EnumGuiId.REMOTE.ordinal(), player.world, (int) player.posX, (int) player.posY, (int) player.posZ);
        }
    }
