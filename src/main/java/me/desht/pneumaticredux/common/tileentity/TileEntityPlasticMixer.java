...
public class TileEntityPlasticMixer extends TileEntityBase implements IHeatExchanger, IRedstoneControlled {
    ...
    private final ItemStackHandler inventory = new PlasticItemStackHandler(INVENTORY_SIZE);
...
//    private static final int[] SLOTS = {0, 1, 2, 3, 4, 5, 6, 7, 8};
    ...
    private static class PlasticFluidTank extends FluidTank {
        public PlasticFluidTank(int capacity) {
            super(capacity);
        }
    ...
    private static class PlasticItemStackHandler extends FilteredItemStackHandler {
        public PlasticItemStackHandler(int inventorySize) {
            super(inventorySize);
        }
