...
public class TileEntityLiquidHopper extends TileEntityOmnidirectionalHopper {
    ...
    protected boolean exportItem(int maxItems) {
        ...
        if (tank.getFluid() != null) {
            ...
            if (neighbor.hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, dir.getOpposite())) {
    ...
    protected boolean suckInItem(int maxItems) {
        ...
        if (inputInv.hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, inputDir.getOpposite())) {
