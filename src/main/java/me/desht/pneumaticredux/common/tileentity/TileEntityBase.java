...
import me.desht.pneumaticredux.common.block.BlockPneumaticCraft;
import me.desht.pneumaticredux.common.inventory.SyncedField;
import me.desht.pneumaticredux.common.item.Itemss;
import me.desht.pneumaticredux.common.network.*;
import me.desht.pneumaticredux.common.thirdparty.computercraft.ILuaMethod;
import me.desht.pneumaticredux.common.thirdparty.computercraft.LuaMethod;
...
//    }
        ...
        if (hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, null)) {
            ...
            if (drained != null && drained.amount > 0) {
                for (EnumFacing d : EnumFacing.VALUES) {
                    ...
                    if (te.hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, d.getOpposite())) {
                        IFluidHandler otherHandler = te.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, d.getOpposite());
                        FluidStack sent = FluidUtil.tryFluidTransfer(handler, otherHandler, drained, true);
                        drained.amount -= sent == null ? 0 : sent.amount;
    ...
    protected void processFluidItem(int inputSlot, int outputSlot) {
        ...
        IFluidTankProperties tankProp = fluidHandler.getTankProperties()[0];
