...
import me.desht.pneumaticredux.common.tileentity.TileEntityElevatorBase;
import me.desht.pneumaticredux.common.tileentity.TileEntityElevatorFrame;
...
public class BlockElevatorFrame extends BlockPneumaticCraftModeled {
    ...
    public RayTraceResult collisionRayTrace(IBlockState state, World world, BlockPos pos, Vec3d origin, Vec3d direction) {
        if (world.isRemote) {
            ItemStack playerStack = PneumaticRedux.proxy.getPlayer().getHeldItemMainhand();
