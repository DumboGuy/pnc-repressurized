            ...
            if (!world.isRemote) {
                ...
                if (te != null) {
                    if (te.isPlayerOnWhiteList(player)) {
                        player.openGui(PneumaticRedux.instance, EnumGuiId.SECURITY_STATION_INVENTORY.ordinal(), world, pos.getX(), pos.getY(), pos.getZ());
                        ...
                        player.openGui(PneumaticRedux.instance, EnumGuiId.HACKING.ordinal(), world, pos.getX(), pos.getY(), pos.getZ());
                    }
                }
            }
            return true;
