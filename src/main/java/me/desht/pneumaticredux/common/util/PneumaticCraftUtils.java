...
import me.desht.pneumaticredux.api.item.IInventoryItem;
...
//            if (w.provider.getDimension() == dimension) {
//                return w;
//            }
//        }
//        return null;
//    }
    ...
    /**
     * Gets a tile entity without risking creation of a new one, which can cause all sorts of problems.
     *
    ...
    public static ResourceLocation RL(String key) {
        return new ResourceLocation(Names.MOD_ID, key);
    }
}
