...
import me.desht.pneumaticredux.common.item.ItemLogisticsFrame;
...
//        return getTileEntity() instanceof IInventory || getTileEntity() instanceof IFluidHandler;
    ...
    public void addWailaTooltip(List<String> curInfo, NBTTagCompound tag) {
        ...
        ItemLogisticsFrame.addTooltip(drops.get(0), PneumaticRedux.proxy.getClientWorld(), curInfo, true);
    }
