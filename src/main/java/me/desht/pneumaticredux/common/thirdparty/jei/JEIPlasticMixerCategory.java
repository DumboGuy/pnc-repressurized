...
import me.desht.pneumaticredux.common.thirdparty.jei.JEIPlasticMixerCategory.PlasticMixerRecipeWrapper;
...
public class JEIPlasticMixerCategory extends PneumaticCraftCategory<PlasticMixerRecipeWrapper> {
    ...
    public String getTitle() {
        return I18n.format(Blockss.plasticMixer.getUnlocalizedName() + ".name");
    }
