...
import me.desht.pneumaticredux.client.gui.GuiUtils;
...
public abstract class PneumaticCraftCategory<T extends IRecipeWrapper> implements IRecipeCategory<T> /*, IRecipeHandler<T> */ {
