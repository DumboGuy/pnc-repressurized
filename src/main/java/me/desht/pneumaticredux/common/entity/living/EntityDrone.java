package me.desht.pneumaticredux.common.entity.living;
...
import me.desht.pneumaticredux.api.drone.IPathNavigator;
...
import me.desht.pneumaticredux.api.tileentity.IManoMeasurable;
import me.desht.pneumaticredux.client.render.RenderProgressingLine;
import me.desht.pneumaticredux.common.DroneRegistry;
import me.desht.pneumaticredux.common.NBTUtil;
import me.desht.pneumaticredux.common.ai.*;
import me.desht.pneumaticredux.common.ai.DroneAIManager.EntityAITaskEntry;
import me.desht.pneumaticredux.common.block.Blockss;
import me.desht.pneumaticredux.common.config.ConfigHandler;
import me.desht.pneumaticredux.common.item.ItemGPSTool;
...
import me.desht.pneumaticredux.common.network.PacketSendDroneDebugEntry;
import me.desht.pneumaticredux.common.network.PacketShowWireframe;
import me.desht.pneumaticredux.common.network.PacketSyncDroneEntityProgWidgets;
import me.desht.pneumaticredux.common.progwidgets.IProgWidget;
import me.desht.pneumaticredux.common.progwidgets.ProgWidgetGoToLocation;
            ...
            for (EnumFacing d : EnumFacing.VALUES) {
                if (getEmittingRedstone(d) > 0) {
                    if (world.isAirBlock(new BlockPos((int) Math.floor(posX + width / 2), (int) Math.floor(posY), (int) Math.floor(posZ + width / 2)))) {
                        world.setBlockState(new BlockPos((int) Math.floor(posX + width / 2), (int) Math.floor(posY), (int) Math.floor(posZ + width / 2)), Blockss.droneRedstoneEmitter.getDefaultState());
                    }
                    break;
                }
            }
