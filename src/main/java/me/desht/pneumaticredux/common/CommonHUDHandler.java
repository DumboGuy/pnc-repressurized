...
import me.desht.pneumaticredux.common.network.PacketHackingBlockFinish;
import me.desht.pneumaticredux.common.network.PacketHackingEntityFinish;
...
public class CommonHUDHandler {
    ...
    public static CommonHUDHandler getHandlerForPlayer(EntityPlayer player) {
        CommonHUDHandler handler = PneumaticRedux.proxy.getCommonHudHandler().playerHudHandlers.get(player.getName());
        if (handler != null) return handler;
        PneumaticRedux.proxy.getCommonHudHandler().playerHudHandlers.put(player.getName(), new CommonHUDHandler());
    ...
    public void tickEnd(TickEvent.PlayerTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            if (this == PneumaticRedux.proxy.getCommonHudHandler()) {
        ...
        if (hackedBlock != null) {
            ...
            if (hackableBlock != null) {
                if (++hackTime >= hackableBlock.getHackTime(hackedBlock.world, hackedBlock.pos, player)) {
                    ...
                    PneumaticRedux.proxy.getHackTickHandler().trackBlock(hackedBlock, hackableBlock);
            ...
            if (hackableEntity != null) {
                if (++hackTime >= hackableEntity.getHackTime(hackedEntity, player)) {
                    ...
                    PneumaticRedux.proxy.getHackTickHandler().trackEntity(hackedEntity, hackableEntity);
