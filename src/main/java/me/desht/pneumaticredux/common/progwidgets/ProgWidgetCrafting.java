...
import me.desht.pneumaticredux.client.gui.programmer.GuiProgWidgetImportExport;
...
public class ProgWidgetCrafting extends ProgWidget implements ICraftingWidget, ICountWidget {
    ...
    public void addErrors(List<String> curInfo, List<IProgWidget> widgets) {
        ...
        if (!usingVariables && getRecipeResult(PneumaticRedux.proxy.getClientWorld()) == null) {
    ...
    public void renderExtraInfo() {
        ItemStack recipe = getRecipeResult(PneumaticRedux.proxy.getClientWorld());
        if (recipe != null) {
