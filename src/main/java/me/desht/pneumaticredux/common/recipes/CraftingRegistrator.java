...
import me.desht.pneumaticredux.common.item.ItemNetworkComponents;
...
public class CraftingRegistrator {
    public static void init() {
        ...
        addShapelessRecipe(new ItemStack(Blockss.pressureChamberGlass, 4), new ItemStack(Blockss.PRESSURE_CHAMBER_WALL), new ItemStack(Blockss.PRESSURE_CHAMBER_WALL), new ItemStack(Blockss.PRESSURE_CHAMBER_WALL), new ItemStack(Blockss.PRESSURE_CHAMBER_WALL), Blocks.GLASS);
        ...
        addShapelessRecipe(new ItemStack(Blockss.pressureChamberGlass), new ItemStack(Blockss.PRESSURE_CHAMBER_WALL), Blocks.GLASS);
        ...
        addRecipe(new ItemStack(Blockss.thermopneumaticProcessingPlant), "igi", "tri", "igi", 'i', Names.INGOT_IRON_COMPRESSED, 'g', "blockGlass", 'r', "dustRedstone", 't', Blockss.PRESSURE_TUBE);
        ...
        addRecipe(new ItemStack(Itemss.GPS_TOOL), " r ", "pgp", "pdp", 'r', Blocks.REDSTONE_TORCH, 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FIRE_FLOWER_DAMAGE), 'g', Blocks.GLASS_PANE, 'd', Items.DIAMOND);
        ...
        addRecipe(new ItemStack(Blockss.liquidCompressor), true, "pbp", "lcl", 'p', Blockss.PRESSURE_TUBE, 'l', Items.LEATHER, 'b', Items.BUCKET, 'c', Blockss.AIR_COMPRESSOR);
        addRecipe(new ItemStack(Blockss.advancedLiquidCompressor), true, "iii", "ibt", "ici", 'i', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.RAIN_PLANT_DAMAGE), 'b', Items.BUCKET, 'c', Blockss.liquidCompressor, 't', Blockss.ADVANCED_PRESSURE_TUBE);
        addRecipe(new ItemStack(Blockss.ELECTROSTATIC_COMPRESSOR), "bpb", "prp", "bcb", 'b', Blocks.IRON_BARS, 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'r', Itemss.TURBINE_ROTOR, 'c', Blockss.AIR_COMPRESSOR);
        ...
        addRecipe(new ItemStack(Itemss.PNEUMATIC_CYLINDER), "pip", "pip", "pbp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.RAIN_PLANT_DAMAGE), 'i', Names.INGOT_IRON_COMPRESSED, 'b', Itemss.cannonBarrel);
        addRecipe(new ItemStack(Blockss.ELEVATOR_BASE, 4, 0), "cp", "pc", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'c', Itemss.PNEUMATIC_CYLINDER);
        addRecipe(new ItemStack(Blockss.ELEVATOR_BASE, 4, 0), "pc", "cp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'c', Itemss.PNEUMATIC_CYLINDER);
        addRecipe(new ItemStack(Blockss.ELEVATOR_CALLER, 1, 0), "cpc", "prp", "cpc", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.SLIME_PLANT_DAMAGE), 'c', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FLYING_FLOWER_DAMAGE), 'r', Items.REDSTONE);
        addRecipe(new ItemStack(Blockss.ELEVATOR_CALLER, 1, 0), "cpc", "prp", "cpc", 'c', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.SLIME_PLANT_DAMAGE), 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FLYING_FLOWER_DAMAGE), 'r', Items.REDSTONE);

        //Security Station
        addRecipe(new ItemStack(Blockss.SECURITY_STATION), "gbg", "tpt", "ggg", 'g', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'b', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.SQUID_PLANT_DAMAGE), 't', Itemss.TURBINE_ROTOR, 'p', Itemss.PRINTED_CIRCUIT_BOARD);
        ...
        addRecipe(new ItemStack(Itemss.NETWORK_COMPONENT, 1, ItemNetworkComponents.NETWORK_REGISTRY), "ttt", "tct", "ttt", 't', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.REPULSION_PLANT_DAMAGE), 'c', Blocks.CHEST);
        addRecipe(new ItemStack(Itemss.NETWORK_COMPONENT, 1, ItemNetworkComponents.DIAGNOSTIC_SUBROUTINE), "ttt", "tct", "ttt", 't', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FIRE_FLOWER_DAMAGE), 'c', Blocks.CHEST);
        addRecipe(new ItemStack(Itemss.NETWORK_COMPONENT, 1, ItemNetworkComponents.NETWORK_API), "ttt", "tct", "ttt", 't', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.RAIN_PLANT_DAMAGE), 'c', Blocks.CHEST);
        addRecipe(new ItemStack(Itemss.NETWORK_COMPONENT, 1, ItemNetworkComponents.NETWORK_DATA_STORAGE), "ttt", "tct", "ttt", 't', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'c', Blocks.CHEST);
        ...
        addRecipe(new ItemStack(Itemss.AMADRON_TABLET, 1, Itemss.AMADRON_TABLET.getMaxDamage()), "ppp", "pgp", "pcp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.BURST_PLANT_DAMAGE), 'g', Itemss.GPS_TOOL, 'c', new ItemStack(Itemss.AIR_CANISTER, 1, Itemss.AIR_CANISTER.getMaxDamage()));
...
//        RecipeSorter.register("pneumaticcraft:fluid", RecipeFluid.class, Category.SHAPED, "after:minecraft:shaped");
        ...
        addRecipe(new ItemStack(Itemss.ADVANCED_PCB), "rpr", "pcp", "rpr", 'c', Itemss.PRINTED_CIRCUIT_BOARD, 'r', Items.REDSTONE, 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.HELIUM_PLANT_DAMAGE));
        addRecipe(new ItemStack(Itemss.ADVANCED_PCB), "prp", "rcr", "prp", 'c', Itemss.PRINTED_CIRCUIT_BOARD, 'r', Items.REDSTONE, 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.HELIUM_PLANT_DAMAGE));
        ...
        //Assembly Machines
        addRecipe(new ItemStack(Blockss.assemblyDrill), true, "dcc", "  c", "ipi", 'd', Items.DIAMOND, 'c', Itemss.PNEUMATIC_CYLINDER, 'i', Names.INGOT_IRON_COMPRESSED, 'p', Itemss.PRINTED_CIRCUIT_BOARD);
        addRecipe(new ItemStack(Blockss.assemblyLaser), true, "dcc", "  c", "ipi", 'd', new ItemStack(Items.DYE, 1, 1), 'c', Itemss.PNEUMATIC_CYLINDER, 'i', Names.INGOT_IRON_COMPRESSED, 'p', Itemss.PRINTED_CIRCUIT_BOARD);
        addRecipe(new ItemStack(Blockss.assemblyIOUnit), true, "hcc", "  c", "ipi", 'h', Blocks.HOPPER, 'c', Itemss.PNEUMATIC_CYLINDER, 'i', Names.INGOT_IRON_COMPRESSED, 'p', Itemss.PRINTED_CIRCUIT_BOARD);
        addRecipe(new ItemStack(Blockss.assemblyPlatform), true, "a a", "ppp", "ici", 'a', Itemss.PNEUMATIC_CYLINDER, 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.PROPULSION_PLANT_DAMAGE), 'i', Names.INGOT_IRON_COMPRESSED, 'c', Itemss.PRINTED_CIRCUIT_BOARD);
        addRecipe(new ItemStack(Blockss.assemblyController), true, " c ", "tcc", "iii", 'i', Names.INGOT_IRON_COMPRESSED, 'c', Itemss.PRINTED_CIRCUIT_BOARD, 't', new ItemStack(Blockss.PRESSURE_TUBE, 1, 0));
        ...
        addRecipe(new ItemStack(Blockss.programmer), "gbg", "tpt", "ggg", 'g', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FIRE_FLOWER_DAMAGE), 'b', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.SQUID_PLANT_DAMAGE), 't', Itemss.TURBINE_ROTOR, 'p', Itemss.PRINTED_CIRCUIT_BOARD);

        addRecipe(new ItemStack(Itemss.LOGISTICS_DRONE), " b ", "bcb", " b ", 'b', Itemss.TURBINE_ROTOR, 'c', "dustRedstone");
        addRecipe(new ItemStack(Itemss.LOGISTICS_FRAME_PASSIVE_PROVIDER), "ppp", "p p", "ppp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.FIRE_FLOWER_DAMAGE));
        addRecipe(new ItemStack(Itemss.LOGISTICS_FRAME_ACTIVE_PROVIDER), "ppp", "p p", "ppp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.ENDER_PLANT_DAMAGE));
        addRecipe(new ItemStack(Itemss.LOGISTICS_FRAME_REQUESTER), "ppp", "p p", "ppp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.RAIN_PLANT_DAMAGE));
        addRecipe(new ItemStack(Itemss.LOGISTICS_FRAME_STORAGE), "ppp", "p p", "ppp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.HELIUM_PLANT_DAMAGE));
        addRecipe(new ItemStack(Itemss.LOGISTICS_FRAME_DEFAULT_STORAGE), "ppp", "p p", "ppp", 'p', new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.REPULSION_PLANT_DAMAGE));
    ...
    private static void addPressureChamberRecipes() {
        ...
        // Empty PCB
        registry.registerPressureChamberRecipe(new Object[]{new ItemStack(Itemss.PLASTIC, 1, ItemPlastic.CREEPER_PLANT_DAMAGE), new ImmutablePair(Names.INGOT_IRON_COMPRESSED, 1)}, 1.5F, new ItemStack[]{new ItemStack(Itemss.EMPTY_PCB, 1, Itemss.EMPTY_PCB.getMaxDamage())});
        // Etching Acid Bucket
        registry.registerPressureChamberRecipe(new ItemStack[]{new ItemStack(Itemss.PLASTIC, 2, ItemPlastic.CREEPER_PLANT_DAMAGE), new ItemStack(Items.ROTTEN_FLESH, 2, 0), new ItemStack(Items.GUNPOWDER, 2, 0), new ItemStack(Items.SPIDER_EYE, 2, 0), new ItemStack(Items.WATER_BUCKET)}, 1.0F, new ItemStack[]{new ItemStack(Fluids.getBucket(Fluids.ETCHING_ACID))});
        // Transistor
